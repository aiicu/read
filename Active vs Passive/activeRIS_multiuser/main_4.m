...
xlabel('Self-interference factor $\delta$ (dB)','Interpreter','latex');
...
save('main_4.mat','Rsum_mean','Rsum_SI_mean','Rsum_SI_no_mean','Rsum_passive_mean','Rsum_random_mean','Rsum_noRIS_mean');
